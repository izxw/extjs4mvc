...
public class Servlets
{
	 ...
	 * 
	 * @param dwzExport true|false 标记是否是Excel导出，导出时需对Value做编码转换
	 */
	public static Map<String, Object> getParametersStartingWith(ServletRequest request, String prefix, boolean dwzExport)
	{
